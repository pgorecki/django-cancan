...
class AliasesTestCase(TestCase):
    ...
    def test_can_view_published(self):
        ...
        self.assertEqual(self.validator.queryset_for("list", Article).count(), 1)
